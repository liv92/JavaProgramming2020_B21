...
public class SumOfUserEnteredNumbers {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Enter desired amount of user inputs");
        int times = scan.nextInt();  // how many numbers user wants to enter, Ex: 5
        ...
        for(int i =1; i <= times ; i++){ // we allowed the user to decide how many number he wants to enter
            System.out.println("Enter a number for input "+i);
