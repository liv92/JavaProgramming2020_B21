...
public class StringMethods3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sentence); //"Python is fun, Python is cool"
        ...
        System.out.println(email); // CybertekSchool@yahoo.com
        ...
        System.out.println(essay); // Batch 21 is cool, Batch 21 is the best, Batch 21 students are awesome

        String s = "I like to learn C#, C# is very cool";

        s = s.replace("C#", "Java");

        System.out.println(s); // I like to learn Java, Java is very cool
        ...
        System.out.println(r); // Dog is friendly, Cat is cute
        ...
        System.out.println(a);  // "Yesterday was Sunday, Today is Monday, Tomorrow is gonna be Tuesday"
